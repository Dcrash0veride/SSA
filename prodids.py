...
def vs_version(i):
    ...
    elif i in range(253, 271):
        return 'Visual Studio 2015', '14.00'
    elif i in range(235, 253):
        return 'Visual Studio 2013', '12.10'
    elif i in range(217, 235):
        return 'Visual Studio 2013', '12.00'
    elif i in range(199, 217):
        return 'Visual Studio 2012', '11.00'
    elif i in range(181, 199):
        return 'Visual Studio 2010', '10.10'
    elif i in range(152, 181): ## TODO": Investigate on Phoenix
        return 'Visual Studio 2010', '10.00'
    elif i in range(131, 152): ## TODO": Investigate on Phoenix
        return 'Visual Studio 2008', '09.00'
    elif i in range(109, 131):
        return 'Visual Studio 2005', '08.00'
    elif i in range(90, 109):
